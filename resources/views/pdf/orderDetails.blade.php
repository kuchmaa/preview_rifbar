...
<section id="ordersSetionWrapper" class="wrapper section-content bg-blue">
	<div class="flex-center col section-remove-db_lr">
		<div id="orderDitails" open class="flex col">
			...
			<div>
				<a href="{{ url('/orders') }}">
					<button id="close" class="transparent_btn">
			...
			<div id="orderDetailsFooter" class="flex row aic">
				<div class="flex col">
					@if(!empty($qrCode))
					<img id="qr" src="data:image/png;base64,{{ $qrCode }}" width="150" alt="QR Code">
					@endif

					<a href="{{ route('orders.downloadQrPdf', $order) }}"
						class="button uppercase size_sl color-blue">
